...
(
    ...
    curl --remote-name-all --silent --show-error \
        https://raw.githubusercontent.com/aisuperapps/superapps_core/master/deploy/template/docker-compose.yml.sh \
        https://raw.githubusercontent.com/aisuperapps/superapps_core/master/deploy/template/mongo-init.js.sh \
        https://raw.githubusercontent.com/aisuperapps/superapps_core/master/deploy/template/docker.env.sh \
        https://raw.githubusercontent.com/aisuperapps/superapps_core/master/deploy/template/nginx_app.conf.sh \
        https://raw.githubusercontent.com/aisuperapps/superapps_core/master/deploy/template/encryption.env.sh
)
